...
void CoreGL::init()
{
    ...
    static const Vertex cubeVerts[] = {
        ...
        {{ 0.5f,-0.5f,-0.5f},{ 0.f, 0.f,-1.f},{0.f,0.f}}, {{-0.5f,-0.5f,-0.5f},{ 0.f, 0.f,-1.f},{1.f,0.f}}, {{ 0.5f, 0.5f,-0.5f},{ 0.f, 0.f,-1.f},{0.f,1.f}},
        {{-0.5f,-0.5f,-0.5f},{ 0.f, 0.f,-1.f},{1.f,0.f}}, {{-0.5f, 0.5f,-0.5f},{ 0.f, 0.f,-1.f},{1.f,1.f}}, {{ 0.5f, 0.5f,-0.5f},{ 0.f, 0.f,-1.f},{0.f,1.f}},
        // Top (+Y): uv from XZ (Fixed to CCW)
        {{-0.5f, 0.5f, 0.5f},{ 0.f, 1.f, 0.f},{0.f,1.f}}, {{ 0.5f, 0.5f, 0.5f},{ 0.f, 1.f, 0.f},{1.f,1.f}}, {{-0.5f, 0.5f,-0.5f},{ 0.f, 1.f, 0.f},{0.f,0.f}},
        {{ 0.5f, 0.5f, 0.5f},{ 0.f, 1.f, 0.f},{1.f,1.f}}, {{ 0.5f, 0.5f,-0.5f},{ 0.f, 1.f, 0.f},{1.f,0.f}}, {{-0.5f, 0.5f,-0.5f},{ 0.f, 1.f, 0.f},{0.f,0.f}},
        // Bottom (-Y): uv from XZ (Fixed to CCW)
        {{-0.5f,-0.5f,-0.5f},{ 0.f,-1.f, 0.f},{0.f,1.f}}, {{ 0.5f,-0.5f,-0.5f},{ 0.f,-1.f, 0.f},{1.f,1.f}}, {{-0.5f,-0.5f, 0.5f},{ 0.f,-1.f, 0.f},{0.f,0.f}},
        {{ 0.5f,-0.5f,-0.5f},{ 0.f,-1.f, 0.f},{1.f,1.f}}, {{ 0.5f,-0.5f, 0.5f},{ 0.f,-1.f, 0.f},{1.f,0.f}}, {{-0.5f,-0.5f, 0.5f},{ 0.f,-1.f, 0.f},{0.f,0.f}},
        // Left (-X): uv from YZ
    ...
    static const Vertex hcVerts[] = {
        ...
        {{-0.5f, 0.5f, 0.5f},{ 1.f, 1.f, 0.f},{1.f,0.f}}, {{ 0.5f,-0.5f, 0.5f},{ 1.f, 1.f, 0.f},{0.f,0.f}}, {{-0.5f, 0.5f,-0.5f},{ 1.f, 1.f, 0.f},{1.f,1.f}},
        {{-0.5f, 0.5f,-0.5f},{ 1.f, 1.f, 0.f},{1.f,1.f}}, {{ 0.5f,-0.5f, 0.5f},{ 1.f, 1.f, 0.f},{0.f,0.f}}, {{ 0.5f,-0.5f,-0.5f},{ 1.f, 1.f, 0.f},{0.f,1.f}},
        // Back face (Z=-0.5): triangle for x+y<=0, CCW from outside (normal = (0,0,-1)) (Fixed to CCW)
        {{-0.5f, 0.5f,-0.5f},{ 0.f, 0.f,-1.f},{0.f,1.f}}, {{ 0.5f,-0.5f,-0.5f},{ 0.f, 0.f,-1.f},{1.f,0.f}}, {{-0.5f,-0.5f,-0.5f},{ 0.f, 0.f,-1.f},{0.f,0.f}},
        // Front face (Z=0.5): triangle, normal = (0,0,1) (Fixed to CCW)
        {{-0.5f,-0.5f, 0.5f},{ 0.f, 0.f, 1.f},{0.f,0.f}}, {{ 0.5f,-0.5f, 0.5f},{ 0.f, 0.f, 1.f},{1.f,0.f}}, {{-0.5f, 0.5f, 0.5f},{ 0.f, 0.f, 1.f},{0.f,1.f}},
    };
...
void CoreGL::setCullFace(bool enable) {
    if (enable) {
